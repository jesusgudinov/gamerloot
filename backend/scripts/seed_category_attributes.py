...
CATEGORIES_DATA = {
    ...
    "Procesadores": ["Familia de procesador", "Socket", "Cantidad de núcleos", "Gráficos integrados", "Incluye disipador"],
    "Tarjetas Madre": ["Socket", "Factor de Forma", "Tecnología RAM", "Velocidad (MT/s)", "Soporte de Almacenamiento", "Chipset", "Capacidad de memoria RAM", "Iluminación"],
    ...
    "Memorias RAM": ["Capacidad de Memoria RAM", "Tecnología RAM", "Velocidad (MT/s)", "Solución Térmica", "Perfiles OC", "Presentación RAM", "Iluminación"],
    "SSD": ["Capacidad", "Interfaz", "Solución Térmica", "Iluminación"],
    "Discos Duros": ["Tipo de uso HDD", "Capacidad", "Interfaz", "Memoria cache", "Velocidad (RPM)"],
    "Enfriamiento Líquido": ["Socket", "Tamaño del radiador", "Tamaño del ventilador", "Tipo de enfriamiento", "Ventiladores incluidos", "Iluminación"],
    "Disipadores": ["Socket", "Tamaño de Disipador", "Tamaño del ventilador", "Tipo de disipador", "Ventiladores incluidos", "Iluminación"],
    "Gabinetes": ["Tamaño de gabinete", "Fuente integrada", "Factor de Forma", "Ventiladores incluidos", "Tamaño del ventilador", "Soporte enfriamiento (líquido)", "Iluminación", "Tipo de ventana", "Color"],
    "Fuentes de poder": ["Gestión de cables", "Potencia en Watts", "Certificación", "Tamaño del ventilador", "Iluminación"],
    "Ventiladores": ["Tamaño del ventilador", "Tipo de ventilador", "Presentación del ventilador", "Velocidad (RPM)", "Iluminación"],
